...
UPDATE_ENV_VARS="AGENT_ENGINE_ID=true,LOGS_BUCKET_NAME=${BUCKET_NAME},IMAGE_LOCATION=${IMAGE_LOCATION},TEXT_MODEL=${TEXT_MODEL},IMAGE_MODEL=${IMAGE_MODEL},THINKING_LEVEL=${THINKING_LEVEL},THINKING_BUDGET=${THINKING_BUDGET},DRIVE_FOLDER_NAME=${DRIVE_FOLDER_NAME}"
