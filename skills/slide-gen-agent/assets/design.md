...
* **Aesthetic**: Structured, data-dense, and highly polished corporate style in bright Light Mode. Specially designed for presenting numbers, metrics, KPIs, and complex processes clearly. Uses a crisp white (`#FFFFFF`) or ultra-light cool gray (`#F8F9FA`) background. Relies on clean grids, structured columns, and borderless card containers with extremely soft, flat drop shadows. Employs thin `#E8EAED` divider lines or elegant primary-colored top accent borders to organize dense information with mathematical precision. High-contrast, clean sans-serif typography with a strong emphasis on giant hero numbers and bold metric callouts.
* **Icons**: Monochrome, flat, ultra-clean business outline icons (rendered in a single solid dark corporate color like deep navy `#1A237E` or slate `#37474F`, exactly 1.5 px to 2 px stroke weight) placed cleanly without any background containers, cards, or 3D effects.
