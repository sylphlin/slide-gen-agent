...
from adk_agent.app_utils import services
from adk_agent.app_utils.a2a import attach_a2a_routes
from adk_agent.app_utils.reasoning_engine_adapter import (
    attach_reasoning_engine_routes,
)
from adk_agent.app_utils.telemetry import (
...
app.title = "slide-gen-agent"
app.description = "API for interacting with the Agent slide-gen-agent"
